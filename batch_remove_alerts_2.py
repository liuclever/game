"""批量移除alert并添加消息提示 - 第二批"""
import re
import os

files = [
    "interfaces/client/src/features/player/PlayerDetailPage.vue",
    "interfaces/client/src/features/map/TeleportPage.vue",
    "interfaces/client/src/features/map/MapPage.vue",
    "interfaces/client/src/features/manor/ManorPlantPage.vue",
    "interfaces/client/src/features/manor/ManorPage.vue",
    "interfaces/client/src/features/manor/ManorExpandPage.vue",
]
...
def process_file(filepath):
    ...
    def replace_alert(match):
        msg = match.group(1)
        # 判断是否是错误消息
        if '失败' in msg or '不足' in msg or '错误' in msg or 'error' in msg.lower() or '无法' in msg or '缺少' in msg:
            return f"showMessage({msg}, 'error')"
        # 判断是否是成功消息
        elif '成功' in msg or 'success' in msg.lower():
