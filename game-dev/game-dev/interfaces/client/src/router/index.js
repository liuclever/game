...
import ShopBuyResultPage from '@/features/shop/ShopBuyResultPage.vue'
import OperationResultPage from '@/features/common/OperationResultPage.vue'
...
import ToastTestPage from '@/features/test/ToastTestPage.vue'
      ...
      },
{
  ...
  },
  {
    path: '/shop/result',
    name: 'ShopBuyResult',
    component: ShopBuyResultPage,
  },
  {
    path: '/operation/result',
    name: 'OperationResult',
    component: OperationResultPage,
  },
  {
    path: '/battlefield',
    name: 'Battlefield',
