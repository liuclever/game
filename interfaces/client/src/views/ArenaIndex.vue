<template>
  <div class="arena-index-page">
    ...
    <div class="section">
      ...
      <a class="link" @click="router.push('/sponsor')">赞助</a>. 
      <a class="link" @click="router.push('/gifts')">礼包</a>
    </div>

    <div class="section">
      <a class="link" @click="router.push('/alliance')">联盟</a>. 
      <a class="link" @click="router.push('/alliance/war')">盟战</a>. 
      <a class="link" @click="router.push('/map')">地图</a>. 
      <a class="link" @click="router.push('/alliance/talent')">天赋</a>. 
    ...
    <div class="section">
      ...
      <a class="link" @click="router.push('/tasks/daily')">成就</a>. 
