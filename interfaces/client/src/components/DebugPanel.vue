...
const loadStatus = async () => {
  ...
  try {
    ...
    resultMessage.value = '加载失败: ' + e.message
  } finally {
    loading.value = false
  }
}
...
const setVip = async () => {
  try {
    ...
    resultMessage.value = res.data?.message || '设置成功'
    loadStatus()
  } catch (e) {
    resultMessage.value = '设置失败: ' + e.message
  }
}
...
const syncVipLevel = async () => {
  try {
    ...
    resultMessage.value = res.data?.message || '同步成功'
    loadStatus()
  } catch (e) {
    resultMessage.value = '同步失败: ' + e.message
  }
}
...
const resetDaily = async () => {
  try {
    ...
    resultMessage.value = res.data?.message || '重置成功'
    loadStatus()
  } catch (e) {
    resultMessage.value = '重置失败: ' + e.message
  }
}
...
const mockRecharge = async (productId) => {
  try {
    ...
    resultMessage.value = res.data?.message || '充值成功'
    loadStatus()
  } catch (e) {
    resultMessage.value = '充值失败: ' + e.message
  }
}
...
const skipDay = async () => {
  try {
    ...
    resultMessage.value = res.data?.message || '已跳转第二天'
    loadStatus()
  } catch (e) {
    resultMessage.value = '跳转失败: ' + e.message
  }
}
...
const batchMonthCard = async (count) => {
  try {
    ...
    resultMessage.value = res.data?.message || '购买成功'
    loadStatus()
  } catch (e) {
    resultMessage.value = '购买失败: ' + e.message
  }
}
...
const addCurrency = async () => {
  try {
    ...
    resultMessage.value = res.data?.message || '添加成功'
    loadStatus()
  } catch (e) {
    resultMessage.value = '添加失败: ' + e.message
  }
}
