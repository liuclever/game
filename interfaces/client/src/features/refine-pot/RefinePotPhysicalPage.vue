...
const cost = aptitudeCosts.physical
const aptitudeKey = 'physical_atk_aptitude'
...
const aptitudeWarning = computed(() => {
  if (!isAptitudeValid.value) return '副幻兽物攻资质需高于主幻兽'
  return ''
})
...
<template>
  <RefinePotAptitudeTemplate
    title="【炼妖壶-物攻资质炼妖】"
    description="对主幻兽进行物攻资质炼化，副幻兽物攻资质越高效果越好"
