...
const cost = aptitudeCosts.magicDefense
const aptitudeKey = 'magic_def_aptitude'
...
const aptitudeWarning = computed(() => {
  if (!isAptitudeValid.value) return '副幻兽法防资质需高于主幻兽'
  return ''
})
...
<template>
  <RefinePotAptitudeTemplate
    title="【炼妖壶-法防资质炼妖】"
    description="对主幻兽进行法防资质炼化，副幻兽法防资质越高效果越好"
