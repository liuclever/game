...
<template>
  <div class="hunting-page">
    ...
    <div class="section title-section">
      【魔魂-猎魂】 <a class="link" @click="() => window.alert('猎魂简介：花费铜钱让猎魂师帮你捕捉魔魂，不同猎魂师获得高品质魔魂的概率不同。')">简介</a>
    </div>
